...
public class Conductor implements Runnable {
     ...
     * <p> 1. Espera a que llegue un pasajero.
     * <p> 2. Empieza a contar el tiempo de espera.
     * <p> 3. Si llegan más pasajeros, los acepta hasta que se llene el tren o pase el
     * tiempo de espera.
     * <p> 4. Inicia el recorrido y espera a que termine.
     * <p> 5. Despierta a los pasajeros, modificando el estado del tren y vuelve a
     * esperar.
     */
    @Override
    public void run() {
        while (true) {
            try {
                ...
                // Comienza a contar el tiempo de espera
